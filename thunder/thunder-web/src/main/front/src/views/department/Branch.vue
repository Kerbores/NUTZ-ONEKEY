<<template>
  <section>
    ...
    <el-table :data="pager.dataList" border stripe style="width: 100%">
      <el-table-tree-column :remote="remote" file-icon="icon icon-file" folder-icon="icon icon-folder" parentKey="parentId" prop="id" label="ID" header-align="center" align="center" width="125"></el-table-tree-column>
            ...
            <el-form 
              ...
              ref="branchForm">
                ...
                <el-form-item label="地址信息" :label-width="formLabelWidth" prop="address">
                    <ali-map @locationSelected="notify"></ali-map>
                </el-form-item>
            </el-form>
