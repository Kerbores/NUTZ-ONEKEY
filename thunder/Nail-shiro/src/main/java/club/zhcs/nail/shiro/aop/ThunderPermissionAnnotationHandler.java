 ...
 * under the License.
 */
package club.zhcs.nail.shiro.aop;
...
public class ThunderPermissionAnnotationHandler extends PermissionAnnotationHandler {
	...
	public void assertAuthorized(Annotation a) throws AuthorizationException {
		...
		InstalledPermission[] perms_ = rpAnnotation.value();
		Subject subject = getSubject();

		final String[] perms = new String[perms_.length];

		Lang.each(perms_, new Each<InstalledPermission>() {

			@Override
			public void invoke(int index, InstalledPermission ele, int length) throws ExitLoop, ContinueLoop, LoopException {
