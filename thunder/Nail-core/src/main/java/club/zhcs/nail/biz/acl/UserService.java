package club.zhcs.nail.biz.acl;
...
import club.zhcs.nail.bean.acl.UserPermission;
...
public class UserService extends BaseService<User> {
	 ...
	 * @return
	 */
	public List<Record> findPermissionsWithUserPowerdInfoByUserId(long id) {
	 ...
	 * @return
	 */
	public List<Record> findRolesWithUserPowerdInfoByUserId(long id) {
